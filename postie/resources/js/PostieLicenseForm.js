...
Craft.Postie.LicenseForm = Craft.BaseElementIndex.extend({
    licenseKey: null,
    ...
    loadLicenseInfo: function(action) {
        Craft.postActionRequest('postie/license/getLicenseInfo', $.proxy(function(response, textStatus) {
    ...
    handleUnregisterLicenseFormSubmit: function(ev) {
        ...
        Craft.postActionRequest('postie/license/unregister', $.proxy(function(response, textStatus) {
    ...
    handleUpdateLicenseFormSubmit: function(ev) {
        ...
        Craft.postActionRequest('postie/license/updateLicenseKey', data, $.proxy(function(response, textStatus) {
    ...
    handleTransferLicenseFormSubmit: function(ev) {
        ...
        Craft.postActionRequest('postie/license/transfer', $.proxy(function(response, textStatus) {
